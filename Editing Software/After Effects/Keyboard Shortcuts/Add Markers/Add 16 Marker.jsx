// Color Selected Keyframes - Color 16.jsx
// Adds a marker at every selected keyframe using color 16

(function () {
    app.beginUndoGroup("Color Selected Keyframes - Color 16");
    ...
    var color = 16; // AE label color 16
